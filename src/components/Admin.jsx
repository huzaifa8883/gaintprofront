...
const AdminPanel = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("https://casino2-production.up.railway.app/api/auth/getalluser");
  ...
  const fetchWithdrawals = async () => {
    try {
      const response = await axios.get("https://casino2-production.up.railway.app/api/auth/allwithdrawls");
  ...
  const handleUpdateDeposit = async (userId) => {
    ...
    try {
      await axios.post("https://casino2-production.up.railway.app/api/auth/updatedeposit", {
        userId,
        currency: "usdt",
